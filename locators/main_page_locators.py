...
class MainPageLocators:
    ...
    list_3 = [By.CLASS_NAME, 'accordion__heading-3']
    list_4 = [By.CLASS_NAME, 'accordion__heading-4']
    list_5 = [By.CLASS_NAME, 'accordion__heading-5']
    list_6 = [By.CLASS_NAME, 'accordion__heading-6']
    list_7 = [By.CLASS_NAME, 'accordion__heading-7']
